if Engine:is_editor_hint() then
	...
	ffi.C.lps_get_template_source_code_cb = wrap_callback(function(class_name, base_class_name, ret)
	...
	ffi.C.lps_validate_cb = wrap_callback(function(script, line_error, col_error, test_error, path, functions)
